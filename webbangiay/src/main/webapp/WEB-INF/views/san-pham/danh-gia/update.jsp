...
<div class="container">
    <form:form action="/danh-gia/update/${danhGia.id}" method="post" modelAttribute="danhGia">
        <div class="row">
            <div class="col-6">
            ...
            <div class="col-6">
                <div class="form-floating mb-3 mt-3">
                    ...
                    <form:label class="form-label" path="chiTietSanPham">chiTietSanPham:</form:label>
