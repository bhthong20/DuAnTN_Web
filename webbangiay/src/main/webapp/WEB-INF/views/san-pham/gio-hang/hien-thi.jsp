        ...
        <tr>
            ...
            <td colspan="2" style="text-align: center">
                <button class="btn btn-info">
                    <a style="color: white;text-decoration: none" href="/gio-hang/view-add">Thêm mới</a>
                </button>
            </td>
        </tr>
        </tbody>
    ...
    <table class="table container">
        ...
        <c:forEach items="${pageData.content}" var="i" varStatus="a">
            <tr>
                ...
                <td>${i.khachHang}</td>
                <td>
                    <a href="/gio-hang/delete/${i.id}" class="btn btn-success"
                    >Delete</a>
                    <a href="/gio-hang/view-update/${i.id}" class="btn btn-success"
                    >Update</a>
                </td>
            </tr>
        </c:forEach>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination">
            <c:if test="${pageData.number > 0}">
                <li class="page-item">
                    <a class="page-link" href="/gio-hang/hien-thi?page=${pageData.number - 1}">Previous</a>
                </li>
            </c:if>
            <li class="page-item"><a class="page-link disabled" href="#">${pageData.number}</a></li>
            <li class="page-item"><a class="page-link" href="/gio-hang/hien-thi?page=${pageData.number + 1}">Next</a></li>
        </ul>
    </nav>
</div>
</body>
