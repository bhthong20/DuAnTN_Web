...
<div>
    <ul class="nav nav-tabs border-top" id="setting-panel" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" href="/hinh-anh/view-add" role="tab" onclick="return myFunction1()">Thêm thông tin ảnh </a>
        </li>
        <a href="/hinh-anh/update-tt" class="btn btn-outline-danger btn-icon-text"
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <%--            Tìm kiếm               --%>
                    <form action="/hinh-anh/search-1" method="post">
                        <div class="row">
                            <div class="col-8">
                        ...
                        <table class="table table-striped">
                            ...
                            <c:forEach var="list" varStatus="i" items="${listAnh}">
                                <tr>
                                    ...
                                    <td>${list.moTa}</td>
                                    <td>
                                        <a href="/hinh-anh/reset-status/${list.id}" class="btn btn-danger btn-icon-text"
                                           tabindex="-1"
                                           role="button"
                                           onclick="if(!(confirm('Bạn có muốn thực hiện thao tác này không ? ')))return false;">
                                            <i class="ti-reload btn-icon-prepend"></i>
                ...
                <c:if test="${total!= 0}">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-center pagination-lg">
                            <li class="page-item"><a class="page-link" href="/hinh-anh/hien-thi-delete?pageNum=0"><</a>
                            </li>

                            <c:forEach begin="1" end="${total}" varStatus="status">
                                <li class="page-item">
                                    <a href="${pageContext.request.contextPath}/hinh-anh/hien-thi-delete?pageNum=${status.index -1}"
                                       class="page-link">${status.index}</a>
                                </li>
                            </c:forEach>

                            <li class="page-item"><a class="page-link"
                                                     href="/hinh-anh/hien-thi-delete?pageNum=${total-1}">></a>
                            </li>
                        </ul>
                    </nav>
                </c:if>
