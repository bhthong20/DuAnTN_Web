    ...
    <table class="table container">
        ...
        <tr class="text-center">
            <td class="text-center" colspan="2">
                ...
                <a type="button" class="btn btn-primary" href="/loai/view-add" onclick="return myFunction6()">Thêm mới phân loại</a>
            </td>
        </tr>
...
<div class="card">
    <div class="table-responsive text-nowrap">
        <table class="table">
            ...
            <c:forEach items="${listMauSac}" var="i" varStatus="a">
                <tr>
                    <td>${a.index+1}</td>
                    <td>${i.ma}</td>
                    <td>${i.tenLoai}</td>
                    ...
                    <td>
                        ...
                        >Delete</a>
                        <a href="/loai/view-update?id=${i.id}" class="btn btn-success" onclick="myFunction8()"
                        >Update</a>
                    </td>
                </tr>
            </c:forEach>
...
<nav aria-label="Page navigation example">
    <ul class="pagination justify-content-center pagination-lg">
        <li class="page-item"><a class="page-link" href="/loai/hien-thi?num=0">First</a>
        </li>
        ...
        <li class="page-item"><a class="page-link" href="/loai/hien-thi?num=${total-1}">Last</a>
        </li>
    </ul>
</nav>
