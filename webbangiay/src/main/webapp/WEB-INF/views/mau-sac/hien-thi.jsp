...
<div class="container">
    <table class="table container">
        ...
        <c:forEach items="${listMauSac}" var="hangSanPham" varStatus="stt">
            <tr>
                ...
                <td>
                    <a href="/mau-sac/delete/${hangSanPham.id}" class="btn btn-success"
                       onclick="return tbxd()">Delete</a>
                    <a href="/mau-sac/view-update/${hangSanPham.id}" class="btn btn-success"
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center pagination-lg">
            ...
            <li class="page-item"><a class="page-link" href="/mau-sac/hien-thi?num=${total-1}">Last</a></li>
        </ul>
    </nav>
</div>
</body>
