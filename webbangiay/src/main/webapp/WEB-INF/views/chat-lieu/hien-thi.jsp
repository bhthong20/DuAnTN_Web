...
<div class="card mb-4">
    <table class="table container">
        <tbody>
        <h3 class="card-header" style="text-align: center">Thông tin chất liệu</h3>
        <tr>
        ...
        <tr class="text-center">
            <td class="text-center" colspan="2">
                ...
                <a type="button" class="btn btn-primary" href="/chat-lieu/view-add" onclick="return myFunction6()">Thêm mới chất liệu</a>
            </td>
        </tr>
...
<div class="card">
    <div class="table-responsive text-nowrap">
        <table class="table">
            ...
            <c:forEach items="${listChatLieu}" var="i" varStatus="stt">
                <tr>
                    <td>${stt.index+1}</td>
                    <td>${i.ma}</td>
                    <td>${i.tenChatLieu}</td>
                    ...
                    <td>${i.moTa}</td>
                    <td>
                        <a href="/chat-lieu/delete/${i.id}" class="btn btn-success" onclick="myFunction7()"
                        >Delete</a>
                        <a href="/chat-lieu/view-update?id=${i.id}" class="btn btn-success" onclick="myFunction8()"
                        >Update</a>
                    </td>
                </tr>
            </c:forEach>
...
<nav aria-label="Page navigation example">
    <ul class="pagination justify-content-center pagination-lg">
        <li class="page-item"><a class="page-link" href="/chat-lieu/hien-thi?num=0">First</a>
        </li>
        ...
        <li class="page-item"><a class="page-link" href="/chat-lieu/hien-thi?num=${total-1}">Last</a>
        </li>
    </ul>
</nav>
