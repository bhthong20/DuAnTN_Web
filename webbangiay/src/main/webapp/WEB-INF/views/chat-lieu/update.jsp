...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="col-md-12">
        <div class="card">
            <h4 class="card-header" style="text-align: center">Update chất liệu</h4>
            <%--@elvariable id="chiTietSanPham" type=""--%>
            <div class="card-body">
                <form:form action="/chat-lieu/update/${chatLieu.id}" method="post" modelAttribute="chatLieu">
                <div class="row">
                    <div class="col-6">
                        <div class="form-floating mb-3 mt-3">
                            ...
                            <form:errors path="tenChatLieu" cssStyle="color: red"></form:errors>
                        </div>
