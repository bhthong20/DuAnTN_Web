...
<body>
<h4 style="text-align: center">Thông tin Hóa Đơn Chi Tiết UPDATE</h4>
<div class="container">
    <form:form action="/hoa-don-chi-tiet/update/${hoaDonCT.id}" method="post" modelAttribute="hoaDonCT">
        <div class="row">
            <div class="col-6">
                <div class="form-floating mb-3 mt-3">
                    <form:input class="form-control" placeholder="" path="soLuong" value="${hoaDonCT.soLuong}"/>
                    <form:label class="form-label" path="soLuong">Số Lượng:</form:label>
                    <form:errors path="soLuong" cssStyle="color: #ff0000"/>
                </div>
                <div class="form-floating mb-3 mt-3">
                    <form:input class="form-control" placeholder="" path="donGia" value="${hoaDonCT.donGia}"/>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <form:select path="chiTietSanPham" class="form-control" id="selectChiTietSanPham"
                                     cssStyle="font-weight: bold; width: 100%">
                            <option selected disabled>ChiTietSamPham </option>
