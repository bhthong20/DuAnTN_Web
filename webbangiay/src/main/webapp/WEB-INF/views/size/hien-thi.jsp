        ...
        <tr>
            ...
            <td colspan="2" style="text-align: center">
                <button class="btn btn-info">
                    <a style="color: white;text-decoration: none" href="/kich-thuoc/view-add">Thêm mới</a>
                </button>
            </td>
        </tr>
        </tbody>
...
<div class="container">
    <table class="table container">
        ...
        <c:forEach items="${listSize}" var="hangSanPham" varStatus="stt">
            <tr>
                <td>${stt.index+1}</td>
                <td>${hangSanPham.ma}</td>
                <td>${hangSanPham.size}</td>
                ...
                <td>
                    <a href="/kich-thuoc/delete/${hangSanPham.id}" class="btn btn-success"
                       onclick="return tbxd()">Delete</a>
                    <a href="/kich-thuoc/view-update/${hangSanPham.id}" class="btn btn-success"
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center pagination-lg">
            <li class="page-item"><a class="page-link" href="/kich-thuoc/hien-thi?num=0">First</a></li>
            ...
            <li class="page-item"><a class="page-link" href="/kich-thuoc/hien-thi?num=${total-1}">Last</a></li>
        </ul>
    </nav>
</div>
</body>
