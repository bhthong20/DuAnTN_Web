...
<body>
<h4 style="text-align: center">Khuyến mãi</h4>
    ...
    <table class="table container">
        ...
        <c:forEach items="${listKhuyenMai}" var="hangSanPham" varStatus="stt">
            <tr>
                ...
                <td>${hangSanPham.ngayBatDau}</td>
                <td>${hangSanPham.ngayKetThuc}</td>
                <td>
                    <c:if test="${hangSanPham.loaiGiamGia==0}">Tiền mặt</c:if>
                    <c:if test="${hangSanPham.loaiGiamGia==1}">%</c:if>
                </td>

                <td>${hangSanPham.giaTriGiam}</td>
                ...
                <td>
                    ...
                    <a href="/khuyen-mai/view-update/${hangSanPham.id}" class="btn btn-success"
