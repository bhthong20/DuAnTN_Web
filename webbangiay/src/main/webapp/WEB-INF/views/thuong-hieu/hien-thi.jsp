    ...
    <table class="table container">
        ...
        <tr class="text-center">
            <td class="text-center" colspan="2">
                ...
                <a type="button" class="btn btn-primary" href="/thuong-hieu/view-add" onclick="return myFunction6()">Thêm mới thương hiệu</a>
            </td>
        </tr>
...
<div class="card">
    <div class="table-responsive text-nowrap">
        <table class="table">
            ...
            <c:forEach items="${pageData}" var="i" varStatus="a">
            <tr>
                <td>${a.index+1}</td>
                <td>${i.ma}</td>
                <td>${i.ten}</td>
                ...
                <td>${i.moTa}</td>
                <td>
                    <a href="/thuong-hieu/delete/${i.id}" class="btn btn-success" onclick="myFunction7()"
                    >Delete</a>
                    <a href="/thuong-hieu/view-update?id=${i.id}" class="btn btn-success" onclick="myFunction8()"
                    >Update</a>
                </td>
            </tr>
            </c:forEach>
