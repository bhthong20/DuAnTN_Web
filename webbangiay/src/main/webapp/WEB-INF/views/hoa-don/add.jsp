...
<body>
<h4 style="text-align: center">Thông tin Update Hóa Đơn</h4>
<div class="container">
    <form:form action="/hoa-don/add" method="post" modelAttribute="hoaDon">
        <div class="row">
            <div class="col-6">
                <div class="form-floating mb-3 mt-3">
                    <form:input class="form-control" placeholder="" path="tenNguoiNhan"/>
                ...
                <div class="form-floating mb-3 mt-3">
                    <form:input class="form-control" placeholder="" path="tongTien"/>
