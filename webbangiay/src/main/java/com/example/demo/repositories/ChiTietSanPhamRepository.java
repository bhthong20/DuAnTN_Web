...
public interface ChiTietSanPhamRepository extends JpaRepository<ChiTietSanPham, UUID> {
    ...
    @Query("select ctsp from ChiTietSanPham ctsp where ctsp.trangThai = 0 and (ctsp.kichThuoc.size like %:search% or ctsp.sanPham.tenSP like %:search% or ctsp.mauSac.ten like %:search% or ctsp.chatLieu.tenChatLieu like %:search%)")
